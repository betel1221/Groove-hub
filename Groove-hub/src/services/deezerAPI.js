      ...
      data: [
        {
          ...
          artist: { id: 1, name: 'Miley Cyrus', picture_small: '/placeholder.svg?height=60&width=60&text=Artist', picture_medium: '/placeholder.svg?height=60&width=60&text=Artist' },
          album: { id: 1, title: 'Endless Summer Vacation', cover_small: '/placeholder.svg?height=200&width=200&text=Album', cover_medium: '/placeholder.svg?height=200&width=200&text=Album' },
        },
        {
          id: 2,
          ...
          artist: { id: 2, name: 'The Weeknd', picture_small: '/placeholder.svg?height=60&width=60&text=Artist', picture_medium: '/placeholder.svg?height=60&width=60&text=Artist' },
          album: { id: 2, title: 'After Hours', cover_small: '/placeholder.svg?height=200&width=200&text=Album', cover_medium: '/placeholder.svg?height=200&width=200&text=Album' },
        },
        {
          id: 3,
          title: 'Shape of You',
          ...
          artist: { id: 3, name: 'Ed Sheeran', picture_small: '/placeholder.svg?height=60&width=60&text=Artist', picture_medium: '/placeholder.svg?height=60&width=60&text=Artist' },
          album: { id: 3, title: '÷ (Divide)', cover_small: '/placeholder.svg?height=200&width=200&text=Album', cover_medium: '/placeholder.svg?height=200&width=200&text=Album' },
        },
        {
          id: 4,
          title: 'Lose Yourself',
          ...
          artist: { id: 4, name: 'Eminem', picture_small: '/placeholder.svg?height=60&width=60&text=Artist', picture_medium: '/placeholder.svg?height=60&width=60&text=Artist' },
          album: { id: 4, title: '8 Mile', cover_small: '/placeholder.svg?height=200&width=200&text=Album', cover_medium: '/placeholder.svg?height=200&width=200&text=Album' },
        },
        {
          id: 5,
          ...
          artist: { id: 4, name: 'Eminem', picture_small: '/placeholder.svg?height=60&width=60&text=Artist', picture_medium: '/placeholder.svg?height=60&width=60&text=Artist' },
          album: { id: 5, title: 'The Marshall Mathers LP', cover_small: '/placeholder.svg?height=200&width=200&text=Album', cover_medium: '/placeholder.svg?height=200&width=200&text=Album' },
        },
        {
          id: 6,
          title: 'Without Me',
          ...
          preview: 'https://cdns-preview-d.dzcdn.net/stream/c-deda7fa9316d9e7fcbecc6e2556e3ede-3.mp3',
          artist: { id: 4, name: 'Eminem', picture_small: '/placeholder.svg?height=60&width=60&text=Artist', picture_medium: '/placeholder.svg?height=60&width=60&text=Artist' },
          album: { id: 6, title: 'The Eminem Show', cover_small: '/placeholder.svg?height=200&width=200&text=Album', cover_medium: '/placeholder.svg?height=200&width=200&text=Album' },
        },
      ],
    },
    albums: {
